...
Route::middleware('auth')->group(function () {
    ...
    Route::match(['get', 'post'],'/dishes/{oper}/{copy?}', 'DishController@crEd')->name('new_dish');
    Route::get('/dish_category', 'DishController@getCategoryList')->name('dish_category');

    Route::get('/products_and_dishes', 'IndexController@productsAndDishes')->name('products_and_dishes');
    ...
    Route::match(['get', 'post'], '/food_diary/copy_day/{token?}', 'FoodDiaryController@copyDay')->name('foodDiaryСopyDay');
    ...
    Route::post('/food_diary/finddp/{id?}', 'FoodDiaryController@findDishesOrProduct')
        ->name('find_dp');
